...
int IVP_Object_Callback_Table_Hash::object_to_index(
    IVP_Real_Object *real_object) {
  IVP_Real_Object *real_obj = real_object;
  return hash_index((const char *)&real_obj, sizeof(real_obj));
}

IVP_BOOL IVP_Object_Callback_Table_Hash::compare(const void *elem0,
                                                 const void *elem1) const {
  const IVP_Object_Callback_Table *table0 =
      (const IVP_Object_Callback_Table *)elem0;
  const IVP_Object_Callback_Table *table1 =
      (const IVP_Object_Callback_Table *)elem1;
