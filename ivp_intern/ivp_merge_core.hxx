 ...
 *	Version Info:   Only limited useage in SDK_1xx, will be used extensively
 *in future versions. Attention:      Not for public useage
 ********************************************************************************/
...
class IVP_Core_Collision : public IVP_Core_Merged {
 public:
  ...
  void
  split_collision_merged_core_next_PSI();  // split this and use next_PSI matrix
};
// INTERN_END
...
class IVP_Merge_Core {
  ...
  IVP_Core *unmovable_core;  // if there is at least one unmoveable core, this
 ...
 public:
  ...
  IVP_Merge_Core(IVP_Core_Merged *mcore, IVP_Core *first_core,
