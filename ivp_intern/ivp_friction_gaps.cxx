...
void IVP_Friction_System::ivp_debug_fs_pointers()
{
    ...
    {
	printf("%zi %zi %d %zi  ",(intp)fr_d->prev_dist_in_friction&0x0000ffff,(intp)fr_d&0x0000ffff,fr_d->has_negative_pull_since,(intp)fr_d->next_dist_in_friction&0x0000ffff);
    }
    printf("\n");
    }
}
