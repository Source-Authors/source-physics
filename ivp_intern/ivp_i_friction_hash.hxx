...
class IVP_Friction_Hash : protected IVP_VHash_Store {
 ...
 public:
  ...
  IVP_Friction_Info_For_Core *remove_friction_info(
      IVP_Friction_Info_For_Core *fs_info) {
    return (IVP_Friction_Info_For_Core *)remove_elem(
        fs_info->l_friction_system);
  };
  ...
  IVP_Friction_Info_For_Core *element_at(int i) {
    return (IVP_Friction_Info_For_Core *)elems_store[i].elem;
  };
