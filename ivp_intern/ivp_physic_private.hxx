...
class IVP_Cluster_Manager {
 ...
 public:
  ...
  void add_listener_object(IVP_Real_Object *real_object,
                           IVP_Listener_Object *listener);
  void remove_listener_object(IVP_Real_Object *real_object,
                              IVP_Listener_Object *listener);

  void fire_event_pre_collision(IVP_Real_Object *ro,
                                IVP_Event_Collision *event_obj);
  void fire_event_post_collision(IVP_Real_Object *ro,
                                 IVP_Event_Collision *event_obj);
  void fire_event_collision_object_deleted(IVP_Real_Object *ro);
  void fire_event_friction_created(IVP_Real_Object *real_object,
                                   class IVP_Event_Friction *event_friction);
  void fire_event_friction_deleted(IVP_Real_Object *real_object,
                                   class IVP_Event_Friction *event_friction);

  void add_listener_collision(IVP_Real_Object *real_object,
                              IVP_Listener_Collision *listener);
  void remove_listener_collision(IVP_Real_Object *real_object,
                                 IVP_Listener_Collision *listener);
