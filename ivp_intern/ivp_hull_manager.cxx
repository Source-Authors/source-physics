...
void IVP_Hull_Manager::delete_hull_manager() {
  while (sorted_synapses.has_elements()) {
    IVP_Listener_Hull *syn =
        (IVP_Listener_Hull *)sorted_synapses.find_min_elem();
    syn->hull_manager_is_going_to_be_deleted_event((IVP_Hull_Manager *)this);
  }
}

void IVP_Listener_Hull::hull_manager_is_reset(IVP_FLOAT /*dt*/,
                                              IVP_FLOAT /*center_dt*/) {
  ;
}
...
void IVP_Hull_Manager::reset_time(IVP_Time offset) { last_vpsi_time -= offset; }
