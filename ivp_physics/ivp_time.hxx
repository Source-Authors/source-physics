...
class IVP_Event_Manager {
 public:
  int mode;
  virtual void simulate_time_events(IVP_Time_Manager *tman,
                                    IVP_Environment *env, IVP_Time until) = 0;
  virtual void simulate_variable_time_step(IVP_Time_Manager *tman,
                                           IVP_Environment *env,
...
class IVP_Event_Manager_Standard : public IVP_Event_Manager {
  void simulate_time_events(IVP_Time_Manager *tman, IVP_Environment *env,
                            IVP_Time until) override;
};

class IVP_Event_Manager_D : public IVP_Event_Manager {
  void simulate_time_events(IVP_Time_Manager *tman, IVP_Environment *env,
                            IVP_Time untilt) override;
};

// Time Manager

// void time_man_sim_until(IVP_Time_Manager *tman,IVP_Environment *env, IVP_Time
// time); void time_man_sim_until_d(IVP_Time_Manager *tman,IVP_Environment *env,
// IVP_Time time);
