 ...
 *	Note:		See IVP_Real_Object if you are looking for the physical
 *side of an object
 ************************************************************************************************/
class IVP_Object {
 ...
 private:
  ...
  IVP_OBJECT_TYPE
  object_type;  // type of this object, e.g. used for correct casts...
 protected:
 ...
 public:
  ...
  IVP_Ball *to_ball() {
    IVP_ASSERT(get_type() == IVP_BALL);
    return (IVP_Ball *)this;
  }
};
