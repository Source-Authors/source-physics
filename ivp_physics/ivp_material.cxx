...
IVP_DOUBLE IVP_Material_Manager::get_friction_factor(
    IVP_Contact_Situation *sit) {
...
IVP_DOUBLE IVP_Material_Manager::get_adhesion(IVP_Contact_Situation *sit) {
  return sit->materials[0]->get_adhesion() + sit->materials[1]->get_adhesion();
}
...
IVP_Material *IVP_Material_Manager::get_material_by_index(
...
IVP_DOUBLE IVP_Material_Simple::get_friction_factor() { return friction_value; }

IVP_DOUBLE IVP_Material_Simple::get_elasticity() { return elasticity; }

// INTERN_START
IVP_DOUBLE IVP_Material_Simple::get_adhesion() { return adhesion; }
// INTERN_END
...
const char *IVP_Material_Simple::get_name() { return "Simple material"; }
