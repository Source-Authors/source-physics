...
void IVP_Forcefield::element_added(IVP_U_Set_Active<IVP_Core> *,
                                   IVP_Core *elem) {
  elem->environment->get_controller_manager()->add_controller_to_core(this,
                                                                      elem);
}

void IVP_Forcefield::element_removed(IVP_U_Set_Active<IVP_Core> *,
                                     IVP_Core *elem) {
  elem->environment->get_controller_manager()->remove_controller_from_core(
      this, elem);
}

IVP_Forcefield::IVP_Forcefield(IVP_Environment *,
...
void IVP_Forcefield::pset_is_going_to_be_deleted(
