...
class IVP_Constraint_Fixed_Keyframed : public IVP_Controller_Dependent {
 protected:
  ...
  virtual const char *get_controller_name() override {
    return "ivp:template_constraint_fixed_keyframed";
  };
 ...
 public:
  ...
  void set_prime_position_Ros(const IVP_U_Point *position_Ros,
                              const IVP_U_Float_Point *velocity_Ros,
                              const IVP_Time &current_time);
  void set_prime_orientation_Ros(const IVP_U_Quat *orientation0_Ros,
