...
void IVP_Template_Controller_Floating::set_position_ws(
    IVP_Real_Object *obj, const IVP_U_Point *pos_ws) {
  IVP_Cache_Object *co = obj->get_cache_object_no_lock();
  co->transform_position_to_object_coords(pos_ws, &position_os);
}

void IVP_Template_Controller_Floating::set_ray_direction_ws(
    IVP_Real_Object *, const IVP_U_Point *dir_ws) {
...
IVP_Controller_Floating::IVP_Controller_Floating(
    IVP_Real_Object *obj, const IVP_Template_Controller_Floating *templ) {
...
void IVP_Controller_Floating::set_current_distance(IVP_DOUBLE cd) {
  current_distance = cd;
};
void IVP_Controller_Floating::set_target_distance(IVP_DOUBLE td) {
  target_distance = td;
};

void IVP_Controller_Floating::set_ray_direction_ws(
    const IVP_U_Float_Point *new_dir) {
...
void IVP_Controller_Floating::do_simulation_controller(
  ...
  tcb.init_reaction_solver_translation_ws(object->get_core(), NULL, position_ws,
                                          &ray_direction_ws, NULL, NULL);
  IVP_DOUBLE a = (current_distance - target_distance) * es->i_delta_time -
...
void IVP_Controller_Floating::core_is_going_to_be_deleted_event(
    IVP_Core *core_i) {
...
IVP_Controller_Floating::~IVP_Controller_Floating() {
  object->get_environment()
      ...
      ->remove_controller_from_core(this, object->get_core());
}
