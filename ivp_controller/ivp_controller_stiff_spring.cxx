...
IVP_Controller_Stiff_Spring::IVP_Controller_Stiff_Spring(
    IVP_Environment *env, IVP_Template_Stiff_Spring *spring_templ)
    : IVP_Actuator_Two_Point(env, spring_templ,
...
void IVP_Controller_Stiff_Spring_Active::active_float_changed(
...
IVP_Controller_Stiff_Spring_Active::IVP_Controller_Stiff_Spring_Active(
    IVP_Environment *env, IVP_Template_Stiff_Spring_Active *spring_templ)
...
void IVP_Controller_Stiff_Spring::do_simulation_controller(
  ...
  scr.init_reaction_solver_translation_ws(pc0, pc1, pos0_ws, &dir_ws, NULL,
                                          NULL);
  IVP_U_Matrix3 &tpm = scr.m_velocity_ds_f_impulse_ds;

  IVP_DOUBLE a =
      (this->spring_len - dlen) * es->i_delta_time * this->spring_constant -
      scr.delta_velocity_ds.k[0] *
          (this->spring_constant +
           this->spring_damp * (1.0f - this->spring_constant));
