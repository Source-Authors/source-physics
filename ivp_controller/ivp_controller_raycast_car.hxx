 ...
 *			of the real car, but CPU time needed is significant
 *lower (1/3 - 1/5) Note:		This is an abstract class, you need to
 *subclass it and implement the do_raycasts function (example implementation:
 *IVP_Example_Controller_Raycast_Car) Attention:	This car does influence
 *moving objects using it's wheels This feature will be implemented soon
 ********************************************************************************/
...
class IVP_Controller_Raycast_Car : public IVP_Car_System,
 ...
 protected:
  ...
  IVP_Raycast_Car_Wheel *get_wheel(IVP_POS_WHEEL i) {
    return &wheels_of_car[i];
  }
  ...
  bool DoSimulationWheels(IVP_Ray_Solver_Template *pRaySolverTemplates,
                          const IVP_U_Matrix *m_world_f_core,
                          IVP_Raycast_Car_Wheel_Temp *pTempWheels,
                          IVP_Ray_Hit *pRayHits, IVP_FLOAT *pFrictions,
                          IVP_Core *pCarCore);
  void DoSimulationStabilizers(IVP_Raycast_Car_Wheel_Temp *pTempWheels);
  void DoSimulationShocks(IVP_Raycast_Car_Wheel_Temp *pTempWheels,
                          IVP_Ray_Hit *pRayHits, IVP_Event_Sim *pEventSim,
                          IVP_Core *pCarCore);
  void DoSimulationBooster(IVP_Event_Sim *pEventSim, IVP_Core *pCarCore);
  void DoSimulationSteering(IVP_Raycast_Car_Wheel_Temp *pTempWheels,
                            IVP_Core *pCarCore, IVP_Event_Sim *pEventSim);

  void CalcSteeringForces(IVP_Raycast_Car_Wheel_Temp *pTempWheels,
                          IVP_Core *pCarCore, IVP_Event_Sim *pEventSim,
                          IVP_FLOAT *pForcesNeededToDriveStraight);
  void ApplySteeringForces(IVP_Raycast_Car_Wheel_Temp *pTempWheels,
 ...
 public:
  ...
  IVP_Controller_Raycast_Car(IVP_Environment *environment,
  ...
  virtual const char *get_controller_name() override {
    return "ivp:controller_raycast_car";
  };
};
