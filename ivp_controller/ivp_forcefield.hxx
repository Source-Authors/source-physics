...
class IVP_Forcefield : protected IVP_Listener_Set_Active<IVP_Core>,
 ...
 protected:
  ...
  IVP_Forcefield(IVP_Environment *env, IVP_U_Set_Active<IVP_Core> *set_of_cores,
                 IVP_BOOL owner_of_set);
