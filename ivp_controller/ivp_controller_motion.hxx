...
class IVP_Template_Controller_Motion {
 public:
  ...
  // --------------------------------------------------------
  IVP_FLOAT
  force_factor;           // force factor   [ 0.. 1.0 .. 1.5f ]     default: 0.8
  IVP_FLOAT damp_factor;  // damp:   [ 0 ...1.0f ..1.5f ]
                          // default: 1.2

  IVP_FLOAT
  torque_factor;  // torque factor   [ 0.. 1.0 .. 1.5f ]     default: 0.8
  IVP_FLOAT angular_damp_factor;  // damp:   [ 0 ...1.0f ..1.5f ]
                                  // default: 1.2
...
class IVP_Controller_Motion : public IVP_Controller_Independent {
 ...
 public:
  ...
  void set_angular_damp_factor(IVP_FLOAT new_val) {
    angular_damp_factor = new_val;
  };
   ...
   *			if your mass center is equal to the objects space
   *origin. use set_target_position_ws
   ********************************************************************************/
  void set_target_object_position_ws(
      IVP_Real_Object *obj, const IVP_U_Quat *desired_orientation,
  ...
  // Methods
  // --------------------------------------------------------
  IVP_Controller_Motion(IVP_Real_Object *object,
                        const IVP_Template_Controller_Motion *templ);
