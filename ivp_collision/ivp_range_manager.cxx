...
IVP_Range_Manager::IVP_Range_Manager(IVP_Environment *env,
  ...
  look_ahead_min_seconds_world =
      0.1f;  // [s] this is real min assert(look_ahead_min_seconds >
             // 2*environment->get_delta_PSI_time())

  look_ahead_time_intra = 0.5f;  // seconds
  look_ahead_max_radius_intra =
      0.9f;  // additional radius as factor of object radius
  look_ahead_min_distance_intra = 0.8f;   // [m]
  look_ahead_max_distance_intra = 10.0f;  // [m]
  look_ahead_min_seconds_intra =
      0.1f;  // [s] this is real min assert(look_ahead_min_seconds >
             // 2*environment->get_delta_PSI_time())
}
...
void IVP_Range_Manager::get_coll_range_intra_objects(
    const IVP_Real_Object *obj0, const IVP_Real_Object *obj1,
...
IVP_DOUBLE IVP_Range_Manager::get_coll_range_in_world(
  ...
  if (max_dist <
      core0->upper_limit_radius + look_ahead_min_seconds_world * speed0) {
    max_dist =
        look_ahead_min_seconds_world * speed0 + core0->upper_limit_radius;
  }
