...
IVP_DOUBLE IVP_Synapse_Real::insert_in_hull_manager(IVP_DOUBLE rel_hull_time) {
  ...
  return l_obj->to_real()->get_hull_manager()->insert_synapse(this, time,
                                                              rel_hull_time);
}

IVP_DOUBLE IVP_Synapse_Real::insert_lazy_in_hull_manager(
    IVP_DOUBLE rel_hull_time) {
  IVP_Time time = l_obj->get_environment()->get_current_time();
  return l_obj->to_real()->get_hull_manager()->insert_lazy_synapse(
      this, time, rel_hull_time);
}
