...
void IVP_OO_Watcher::hull_limit_exceeded_event() {
  ...
  env->get_mindist_manager()->create_exact_mindists(
      obj0, obj1, dist0 + dist1, &mindists, NULL, NULL, NULL, NULL, this);
...
void IVP_Synapse_OO::hull_manager_is_going_to_be_deleted_event(
    IVP_Hull_Manager *) {
...
void IVP_Synapse_OO::init_synapse_oo(IVP_OO_Watcher *w, IVP_Real_Object *obj) {
  ...
  object = obj;
  hull_manager->insert_synapse(this, obj->get_environment()->get_current_time(),
                               P_FLOAT_MAX);  // dummy time
  watcher = w;
}
...
IVP_OO_Watcher::IVP_OO_Watcher(IVP_Collision_Delegator *del,
                               IVP_Real_Object *obj0, IVP_Real_Object *obj1)
    : IVP_Collision(del), mindists(8) {
