...
class IVP_Sphere_Solver {
 public:
  ...
  /**
   * Check the sphere against the environment and fill in the
   * m_intruding_objects vector accordingly.
   *
   * @param tmpl A IVP_Sphere_Solver_Template structure to initialize the sphere
   * solver
   * @param env The IVP_Environment to query
   */
  void check_sphere_against_environment(const IVP_Sphere_Solver_Template* tmpl,
                                        IVP_Environment* env);
   ...
   */
  IVP_BOOL check_sphere_against_object(const IVP_Sphere_Solver_Template* tmpl,
                                       IVP_Real_Object* obj);
 ...
 private:
  ...
  void recursively_collect_intruding_objects(IVP_OV_Node* node,
                                             IVP_U_Float_Point* query_rlb,
