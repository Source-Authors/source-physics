...
void IVP_Collision_Delegator_Root_Mindist::
    object_is_removed_from_collision_detection(IVP_Real_Object *o) {
...
void IVP_Collision_Delegator_Root_Mindist::
    environment_is_going_to_be_deleted_event(IVP_Environment *) {
  P_DELETE_THIS(this);
}

void IVP_Collision_Delegator_Root_Mindist::
    collision_is_going_to_be_deleted_event(class IVP_Collision *t) {
...
IVP_Collision *
IVP_Collision_Delegator_Root_Mindist::delegate_collisions_for_object(
    IVP_Real_Object *obj0, IVP_Real_Object *obj1) {
  IVP_Collision *coll;
#if 1
  const IVP_Compact_Ledge *l0 =
      obj0->get_surface_manager()->get_single_convex();
  const IVP_Compact_Ledge *l1 =
      obj1->get_surface_manager()->get_single_convex();
  ...
  if (l0 && l1) {
    ...
    md->init_mindist(obj0, obj1, tri0->get_first_edge(),
                     tri1->get_first_edge());
    coll = md;
  } else {
