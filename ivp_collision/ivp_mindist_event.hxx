...
class IVP_Mindist_Event_Solver {
 ...
 protected:
  ...
  static void next_event_default_poly_poly(
      IVP_Mindist_Event_Solver *);  // not all cases
  static void next_event_B_POLY(IVP_Mindist_Event_Solver *);

  static void next_event_BB(IVP_Mindist_Event_Solver *);

  static void (*mim_function_table[IVP_ST_MAX_LEGAL][IVP_ST_MAX_LEGAL])(
      IVP_Mindist_Event_Solver *mms);

 protected:
  /** calc the delta time of the next event, returns max_delta_time when no
   * events found */
  void calc_next_event_PF(const IVP_Compact_Edge *P, const IVP_Compact_Edge *F,
                          IVP_Cache_Ledge_Point *m_cache_P,
                          IVP_Cache_Ledge_Point *m_cache_F);

  void calc_next_event_PP(const IVP_Compact_Edge *P, const IVP_Compact_Edge *P2,
                          IVP_Cache_Ledge_Point *m_cache_P,
                          IVP_Cache_Ledge_Point *m_cache_P2);

  void calc_next_event_PK(const IVP_Compact_Edge *P, const IVP_Compact_Edge *K,
                          IVP_Cache_Ledge_Point *m_cache_P,
                          IVP_Cache_Ledge_Point *m_cache_K);

  void calc_next_event_KK(const IVP_Compact_Edge *P, const IVP_Compact_Edge *K2,
                          IVP_Cache_Ledge_Point *m_cache_K,
  ...
  void calc_next_event_BP(IVP_Ball *B, const IVP_Compact_Edge *P,
                          IVP_Cache_Object *m_cache_B,
                          IVP_Cache_Ledge_Point *m_cache_P);
  void calc_next_event_BB(IVP_Cache_Object *m_cache_A,
                          IVP_Cache_Object *m_cache_B);
