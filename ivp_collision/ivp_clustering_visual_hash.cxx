...
IVP_BOOL IVP_Clustering_Visualizer_Object_Hash::compare(
...
IVP_Real_Object *IVP_Clustering_Visualizer_Object_Hash::remove(
    IVP_Real_Object *obj) {
  return (IVP_Real_Object *)remove_elem(obj, obj_to_index(obj));
}

IVP_Real_Object *IVP_Clustering_Visualizer_Object_Hash::find(
    IVP_Real_Object *obj) {
