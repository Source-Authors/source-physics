 ...
 *compact grid class. This class is vital to generate physical representations
 *of the compact grid. Classes:	    IVP_SurfaceManager_Grid
 ********************************************************************************/
 ...
 *		    grid objects. This is sort of an interface to the compact
 *grid (geometrical topology) and some of its basic values. Note:	    Use
 *these methods instead of directly accessing the compact grid!
 *******************************************************************************/
...
class IVP_SurfaceManager_Grid : public IVP_SurfaceManager {
 ...
 public:
  ...
  void insert_all_ledges_hitting_ray(IVP_Ray_Solver *,
   ...
   *	Output:		Returns the ledge if compact grid consists of exactly
   *one (convex) ledge. Note:		If the compact grid is concave, but
   *consists of two or more (convex) ledges (e.g. a cube made out of four
   ...
   *	Input:		<observer_os>      center point of observation (in
   *compact grid coordinate system!) <radius>           radius to check
