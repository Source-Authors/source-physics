 ...
 *  Description:    This file provides you with a support class for easy
 *handling of halfspace planes. Classes:	    IVP_Halfspacesoup
 ********************************************************************************/
 ...
 *		    planes.
 *		    A halfspace plane is an infinite (virtual) plane that
 *divides space into two discreet parts. Note:	    The Ipion engine uses
 *halfspace planes to describe discreet volumes in space. For this it will
 *expect the normal vectors of the supplied planes to point AT the enclosed
 *volume (and not away from it)! Note:	    You should add new planes by using
 *the supplied "add_halfspace" method!
 *******************************************************************************/
