...
enum IVP_POP_TYPE { IVP_POP_TYPE_NORMAL, IVP_POP_TYPE_CLOSING };
...
class IVP_Tetra_Intrude {
  ...
  IVP_INTRUSION_CHECK_RESULTS check_point_intrusion(
      int bitmask[3], IVP_Tetra_Point *t_points[4], IVP_U_Hesse hesse_of_t[4],
      IVP_DOUBLE p_pop_eps[4], IVP_U_Hesse edge_hesses[6], IVP_Tetra_Point *tp,
 ...
 public:
  ...
  IVP_INTRUSION_CHECK_RESULTS check_intrusion(
