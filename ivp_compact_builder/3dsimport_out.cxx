...
void OutpHead(FILE* o, H3dsScene* scene, int verts, char* name, int f) {
  fprintf(o,
          ...
          " 0\n"
          "};\n",
          name, name, name, name, name, f, verts, scene->meshobjs, name, name,
          name, name, name, name);
}
...
void OutpHeadAsm(FILE* o, H3dsScene* scene, int verts, char* name, int f) {
  fprintf(o,
          ...
          " dd %s__iii-%s_\n"
          " dd 0\n",
          name, name, f, verts, scene->meshobjs, name, name, name, name, name,
          name);
}
...
void OutpVerts(FILE* o, H3dsMapVert* vrtmap, int verts, char* name, int /*f*/) {
...
void OutpVertsAsm(FILE* o, H3dsMapVert* vrtmap, int verts, char* name, int f) {
...
void OutpCentres(FILE* o, H3dsScene* scene, char* name) {
  ...
  for (int n = 0; n < scene->meshobjs; n++) {
    ...
    fprintf(o, "%6d,%6d,%6d,\n", (int)mo->centre.ix, (int)mo->centre.iy,
            (int)mo->centre.iz);
  }
  if (scene->meshobjs > 1)
    fprintf(o, "%6d,%6d,%6d\n", (int)scene->centre.ix, (int)scene->centre.iy,
            (int)scene->centre.iz);
  fprintf(o, "};\n");
}
