...
IVP_Template_Polygon::IVP_Template_Polygon(int point_count, int line_count,
                                           int surface_count) {
...
void IVP_Template_Surface::calc_surface_normal_template(int a, int b, int c) {
  ...
  my_hesse.calc_hesse(&templ_poly->points[a], &templ_poly->points[b],
                      &templ_poly->points[c]);
  my_hesse.normize();
...
IVP_Template_Surface::~IVP_Template_Surface() { this->close_surface(); }
