...
int IVP_SurfaceBuilder_Polyhedron_Concave::
...
void IVP_SurfaceBuilder_Polyhedron_Concave::
  ...
  for (int i = 0; i < n_faces; i++) {
    ...
    for (int j = 0; j < n_points_of_face; j++) {
      IVP_U_Point *p =
          points_in->element_at(face->point_offset.element_at(j)->offset);
      points.add(p);
    }
...
IVP_Compact_Surface *IVP_SurfaceBuilder_Polyhedron_Concave::
  ...
  IVP_SurfaceBuilder_Polyhedron_Concave::
      convert_concave_polyhedron_to_compact_ledges(concave_polyhedron_in,
                                                   params, &ledges_local);
