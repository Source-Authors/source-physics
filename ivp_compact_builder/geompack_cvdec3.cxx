...
void IVP_Geompack::cvdec3_() {
   ...
   * see routine DSPHDC */
  /*        EDGE_ANGLES(1:ADDR_OF_N_WORK_VERTICES) - angles at edges common to 2
   * faces in a polyh; */
  /*              EDGE_ANGLES(J) corresponds to FACEVERTICESLIST(*,J),
      ...
      IVP_IF(1) {
        IVP_IFDEBUG(IVP_DM_GEOMPACK_LEVEL1, {
          ivp_debugmanager.dprint(IVP_DM_GEOMPACK_LEVEL1,
                                  "*** GEOMPACK: at least one reflex edge has "
                                  "not been resolved by routine RESEDG\n");
        })
      }
      return;
    } else {
