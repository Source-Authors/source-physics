...
void qh_allstatA(void) {
  ...
  zdef_(wadd, Wnewvertex, "ave. distance of a new vertex to a facet (not 0s)",
        Znewvertex);
  ...
  zzdef_(zinc, Zcoplanarhorizon, "coplanar horizon facets for new vertices",
         -1);
  zzdef_(zinc, Zcoplanarpart, "coplanar points during partitioning", -1);
  zzdef_(zinc, Zminnorm,
         "degenerate hyperplanes recomputed with gaussian elimination", -1);
  zzdef_(zinc, Znearlysingular, "nearly singular or axis-parallel hyperplanes",
         -1);
...
void qh_allstatB(void) {
  ...
  zdef_(zadd, Znumneighbors, "average number of neighbors per facet",
        Znumfacets);
  zdef_(zmax, Zmaxneighbors, "maximum number of neighbors", -1);
  zdef_(zadd, Znumvertices, "average number of vertices per facet", Znumfacets);
  zdef_(zmax, Zmaxvertices, "maximum number of vertices", -1);
  zdef_(zadd, Znumvneighbors, "average number of neighbors per vertex",
        Zvertices);
  ...
  zdef_(zadd, Znummergetot, "average merges per facet (at most 511)",
        Znumfacets);
...
void qh_allstatC(void) {
  ...
  zdef_(zinc, Zinsidevisible,
        "  ave. visible facets without an horizon neighbor", Zprocessed);
  zdef_(zadd, Zvisfacettot, "  ave. facets deleted per iteration", Zprocessed);
  zdef_(zmax, Zvisfacetmax, "    maximum", -1);
  zdef_(zadd, Zvisvertextot, "ave. visible vertices per iteration", Zprocessed);
  zdef_(zmax, Zvisvertexmax, "    maximum", -1);
  zdef_(zadd, Zdelvertextot, "  ave. vertices deleted per iteration",
        Zprocessed);
  zdef_(zmax, Zdelvertexmax, "    maximum vertices deleted", -1);
  zdef_(zinc, Ztothorizon, "ave. horizon facets per iteration", Zprocessed);
  zdef_(zadd, Znewfacettot, "ave. new or merged facets per iteration",
        Zprocessed);
  ...
  zdef_(zinc, Znotgoodnew, "points ignored (didn't create a good new facet)",
        -1);
...
void qh_allstatD(void) {
  ...
  zdef_(zinc, Zcoplanarinside,
        "  inside points that were coplanar with a facet", -1);
  ...
  zdef_(zinc, Ztotpartcoplanar,
        "partitions of coplanar points or deleted vertices", -1);
  zzdef_(zinc, Zpartcoplanar, "   distance tests for these partitions", -1);
  zdef_(zinc, Zcomputefurthest, "distance tests for computing furthest", -1);
}
void qh_allstatE(void) {
  zdef_(zdoc, Zdoc5, "statistics for matching ridges", -1);
  zdef_(zinc, Zhashlookup, "total lookups for matching ridges of new facets",
        -1);
  zdef_(zinc, Zhashtests, "average number of tests to match a ridge",
        Zhashlookup);
  zdef_(zinc, Zhashridge,
        "total lookups of subridges (duplicates and boundary)", -1);
  zdef_(zinc, Zhashridgetest, "average number of tests per subridge",
        Zhashridge);
  ...
  zzdef_(zinc, Zdistzero, "distance tests for checking simplicial convexity",
         -1);
...
void qh_allstatF(void) {
  ...
  zdef_(zadd, Zmergeinittot, "ave. initial non-convex ridges per iteration",
        Zpremergetot);
  zdef_(zadd, Zmergeinitmax, "  maximum", -1);
  zdef_(zadd, Zmergesettot, "  ave. additional non-convex ridges per iteration",
        Zpremergetot);
  zdef_(zadd, Zmergesetmax, "  maximum additional in one pass", -1);
  zdef_(zadd, Zmergeinittot2, "initial non-convex ridges for post merging", -1);
  zdef_(zadd, Zmergesettot2, "  additional non-convex ridges", -1);
  zdef_(wmax, Wmaxoutside,
        "max distance of vertex or coplanar point above facet (w/roundoff)",
        -1);
  zdef_(wmin, Wminvertex,
        "max distance of merged vertex below facet (or roundoff)", -1);
  zdef_(zinc, Zwidefacet, "centrums frozen due to a wide merge", -1);
  zdef_(zinc, Zwidevertices, "centrums frozen due to extra vertices", -1);
  zzdef_(zinc, Ztotmerge, "total number of facets or cycles of facets merged",
         -1);
  zdef_(zinc, Zmergesimplex, "merged a simplex", -1);
  zdef_(zinc, Zonehorizon, "simplices merged into coplanar horizon", -1);
  zzdef_(zinc, Zcyclehorizon, "cycles of facets merged into coplanar horizon",
         -1);
  ...
  zdef_(zinc, Zcyclevertex, "vertices deleted by merging into coplanar horizon",
        -1);
  zdef_(zinc, Zdegenvertex, "vertices deleted by degenerate facet", -1);
  zdef_(zinc, Zmergeflipdup, "merges due to flipped facets in duplicated ridge",
        -1);
...
void qh_allstatG(void) {
  ...
  zdef_(zinc, Zavoidold, "coplanar/concave merges due to avoiding old merge",
        -1);
...
void qh_allstatH(void) {
  ...
  zdef_(zinc, Zintersectnum,
        "vertex intersections for locating redundant vertices", -1);
  zdef_(zinc, Zintersectfail, "intersections failed to find a redundant vertex",
        -1);
  zdef_(zinc, Zintersect, "intersections found redundant vertices", -1);
  zdef_(zadd, Zintersecttot, "   ave. number found per vertex", Zintersect);
  zdef_(zmax, Zintersectmax, "   max. found for a vertex", -1);
  zdef_(zinc, Zvertexridge, NULL, -1);
  zdef_(zadd, Zvertexridgetot, "  ave. number of ridges per tested vertex",
        Zvertexridge);
  zdef_(zmax, Zvertexridgemax, "  max. number of ridges per tested vertex", -1);

  zdef_(zdoc, Zdoc10, "memory usage statistics (in bytes)", -1);
  zdef_(zadd, Zmemfacets,
        "for facets and their normals, neighbor and vertex sets", -1);
...
void qh_allstatistics(void) {
  ...
  for (i = ZEND; i--;) qhstat printed[i] = False;
} /* allstatistics */
...
void qh_collectstatistics(void) {
  ...
  qh RANDOMdist = False;
  zval_(Zmempoints) =
      qh num_points * qh normal_size + sizeof(qhT) + sizeof(qhstatT);
  zval_(Zmemfacets) = 0;
  zval_(Zmemridges) = 0;
  ...
  if (qh MERGING) wmin_(Wminvertex, qh min_vertex);
  FORALLfacets facet->seen = False;
  if (qh DELAUNAY) {
    FORALLfacets {
  ...
  FORALLfacets {
    if (facet->visible && qh NEWfacets) continue;
    ...
    if (facet->ridges) {
      zadd_(Zmemridges, sizeof(setT) + SETelemsize * sizridges +
                            sizridges *
                                (sizeof(ridgeT) + sizeof(setT) +
                                 SETelemsize * (qh hull_dim - 1)) /
                                2);
    }
    if (facet->outsideset)
      zadd_(Zmempoints,
            sizeof(setT) + SETelemsize * qh_setsize(facet->outsideset));
    if (facet->coplanarset)
      zadd_(Zmempoints,
            sizeof(setT) + SETelemsize * qh_setsize(facet->coplanarset));
...
boolT qh_nostatistic(int i) {
  if ((qhstat type[i] > ZTYPEreal &&
       hk_Math::almost_equal(qhstat stats[i].r,
                             qhstat init[(unsigned char)(qhstat type[i])].r)) ||
...
void qh_printstatistics(FILE *fp, const char *string) {
  ...
  if (qh num_points != qh num_vertices) {
    ...
    wval_(Wpbalance2) =
        qh_stddev(zval_(Zpbalance), wval_(Wpbalance), wval_(Wpbalance2), &ave);
...
%s\n\
 qhull invoked by: %s | %s\n%s with options:\n%s\n",
          string, qh rbox_command, qh qhull_command, qh_version,
          qh qhull_options);
  fprintf(fp,
          "\nprecision constants:\n\
...
",
 ...
 %6.2g min. denominator for divisions\n\
  zero diagonal for Gauss: ",
          qh ONEmerge, REALepsilon, qh MINdenom);
  for (k = 0; k < qh hull_dim; k++) fprintf(fp, "%6.2e ", qh NEARzero[k]);
  fprintf(fp, "\n\n");
  for (i = 0; i < qhstat next;) qh_printstats(fp, i, &i);
} /* printstatistics */
#endif /* qh_KEEPstatistics */
...
void qh_printstatlevel(FILE *fp, int id, [[maybe_unused]] int start) {
  ...
  if (id >= ZEND || qhstat printed[id]) return;
  if (qhstat type[id] == zdoc) {
    fprintf(fp, "%s\n", qhstat doc[id]);
    return;
  }
  start = 0; /* not used */
  if (qh_nostatistic(id) || !qhstat doc[id]) return;
  ...
  if (qhstat count[id] != -1 &&
    ...
    fprintf(
        fp, "%7.2g",
        qhstat stats[id].r / qhstat stats[(unsigned char)(qhstat count[id])].i);
  else if (qhstat type[id] < ZTYPEreal && qhstat count[id] == -1)
    fprintf(fp, "%7d", qhstat stats[id].i);
  else if (qhstat type[id] < ZTYPEreal && qhstat count[id] != -1)
    fprintf(fp, "%7.3g",
            (realT)qhstat stats[id].i /
                qhstat stats[(unsigned char)(qhstat count[id])].i);
  fprintf(fp, " %s\n", qhstat doc[id]);
} /* printstatlevel */
...
void qh_printstats(FILE *fp, int index, int *nextindex) {
  ...
  if (qh_newstats(index, &nexti)) {
    fprintf(fp, "\n");
    for (j = index; j < nexti; j++) qh_printstatlevel(fp, qhstat id[j], 0);
  }
  if (nextindex) *nextindex = nexti;
} /* printstats */
