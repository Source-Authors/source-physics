 ...
 *					handled by the collision detection
 *engine as a convex polyhedron Attention:	The base polygon HAS TO BE
 *convex! Version Info:	This file is old, it's just used for IVP internals
 ********************************************************************************/
class IVP_SurfaceBuilder_Polygon_Convex {
 ...
 protected:
  ...
  static IVP_Compact_Ledge *convert_template_to_ledge(
      IVP_Template_Polygon *templat);  // to be used by polygon soup
  static IVP_Compact_Ledge *convert_templateledgepolygonsoup_to_ledge(
 ...
 public:
  ...
  /////// very public
  static IVP_SurfaceManager_Polygon *create_surface_manager(
