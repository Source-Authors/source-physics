...
void IVP_Geompack::insvr3_(int a) {
  ...
  /*     Input parameters: */
  /*        A - index of FACEVERTICESLIST specifying edge containing inserted
   * vertex */
   ...
   * FACEVERTICESLIST, EDGE_ANGLES arrays */
  /*        VCL(1:3,1:ADDR_OF_N_ORIGINAL_VERTICES+1) - vertex coordinate list;
   * VCL(*,ADDR_OF_N_ORIGINAL_VERTICES+1) are */
  ...
  /*     Find start edge of FACEVERTICESLIST if AB lies on boundary of
   * decomposition. */
