...
inline void IVP_U_Float_Point::subtract(const IVP_U_Point *v1,
...
inline void IVP_U_Float_Point::set_multiple(const IVP_U_Point *v,
                                            IVP_DOUBLE f) {
...
inline void IVP_U_Point::set_multiple(const IVP_U_Quat *q_source,
                                      IVP_DOUBLE f) {
...
inline void IVP_U_Point::add_multiple(const IVP_U_Float_Point *v,
                                      IVP_DOUBLE factor) {
  IVP_DOUBLE a, b, c;
  a = v->k[0] * factor;
  b = v->k[1] * factor;
...
inline void IVP_U_Point::add_multiple(const IVP_U_Point *v1,
                                      const IVP_U_Point *v2,
...
inline void IVP_U_Point::set_pairwise_mult(
    const IVP_U_Point *v1, const IVP_U_Point *v2) {  // pairwise multiple
  IVP_DOUBLE a, b, c;
  a = v1->k[0] * v2->k[0];
  b = v1->k[1] * v2->k[1];
  c = v1->k[2] * v2->k[2];
...
inline void IVP_U_Point::add(const IVP_U_Float_Point *v1,
                             const IVP_U_Float_Point *v2) {
  IVP_DOUBLE a = v1->k[0] + v2->k[0];
  IVP_DOUBLE b = v1->k[1] + v2->k[1];
  IVP_DOUBLE c = v1->k[2] + v2->k[2];
...
inline void IVP_U_Point::subtract(
    const IVP_U_Point *v2) {  // vector subtraction
  IVP_DOUBLE a, b, c;
  a = k[0] - v2->k[0];
  b = k[1] - v2->k[1];
  c = k[2] - v2->k[2];
...
inline void IVP_U_Point::subtract(
    const IVP_U_Float_Point *v2) {  // vector subtraction
  IVP_DOUBLE a, b, c;
  a = k[0] - v2->k[0];
  b = k[1] - v2->k[1];
  c = k[2] - v2->k[2];
...
inline void IVP_U_Point::subtract(const IVP_U_Point *v1,
                                  const IVP_U_Point *v2) {
  IVP_DOUBLE a, b, c;
  a = v1->k[0] - v2->k[0];
  b = v1->k[1] - v2->k[1];
...
inline void IVP_U_Point::subtract(const IVP_U_Float_Point *v1,
                                  const IVP_U_Float_Point *v2) {
...
inline void IVP_U_Point::inline_subtract_and_mult(
    const IVP_U_Point *v1, const IVP_U_Point *v2,
    IVP_DOUBLE factor) {  // vektor addition
  IVP_DOUBLE a, b, c;
  a = (v1->k[0] - v2->k[0]);
...
inline IVP_DOUBLE IVP_U_Point::quad_distance_to(
...
inline void IVP_U_Matrix::inline_vimult4(const IVP_U_Point *p_in,
                                         IVP_U_Point *p_out) const {
    IVP_IF_WILLAMETTE_OPT(0){IVP_DOUBLE a = p_in -> k[0] - vv.k[0];
...
inline void IVP_U_Matrix3::inline_vmult3(const IVP_U_Point *p_in,
                                         IVP_U_Point *p_out) const {
  IVP_DOUBLE a = get_elem(0, 0) * p_in->k[0] + get_elem(0, 1) * p_in->k[1] +
                 get_elem(0, 2) * p_in->k[2];
  IVP_DOUBLE b = get_elem(1, 0) * p_in->k[0] + get_elem(1, 1) * p_in->k[1] +
                 get_elem(1, 2) * p_in->k[2];
  IVP_DOUBLE c = get_elem(2, 0) * p_in->k[0] + get_elem(2, 1) * p_in->k[1] +
                 get_elem(2, 2) * p_in->k[2];
  p_out->k[0] = a;
  p_out->k[1] = b;
  p_out->k[2] = c;
};

inline void IVP_U_Matrix3::inline_vimult3(const IVP_U_Point *p_in,
                                          IVP_U_Point *p_out) const {
  IVP_DOUBLE a = get_elem(0, 0) * p_in->k[0] + get_elem(1, 0) * p_in->k[1] +
                 get_elem(2, 0) * p_in->k[2];
  IVP_DOUBLE b = get_elem(0, 1) * p_in->k[0] + get_elem(1, 1) * p_in->k[1] +
                 get_elem(2, 1) * p_in->k[2];
  IVP_DOUBLE c = get_elem(0, 2) * p_in->k[0] + get_elem(1, 2) * p_in->k[1] +
                 get_elem(2, 2) * p_in->k[2];
  p_out->k[0] = a;
  p_out->k[1] = b;
  p_out->k[2] = c;
...
inline void IVP_U_Matrix::inline_vmult4(const IVP_U_Point *p_in,
                                        IVP_U_Point *p_out) const {
...
void IVP_U_Point::inline_calc_cross_product(const IVP_U_Point *v1,
                                            const IVP_U_Point *v2) {
  IVP_DOUBLE a = v1->k[1] * v2->k[2];
  IVP_DOUBLE a2 = v2->k[1] * v1->k[2];
  IVP_DOUBLE b = v1->k[2] * v2->k[0];
  IVP_DOUBLE b2 = v2->k[2] * v1->k[0];
  a -= a2;
  IVP_DOUBLE c = v1->k[0] * v2->k[1];
  IVP_DOUBLE c2 = v2->k[0] * v1->k[1];
  b -= b2;
  k[0] = a;
  k[1] = b;
  c -= c2;
...
void IVP_U_Point::inline_set_vert_to_area_defined_by_three_points(
...
void IVP_U_Point::inline_calc_cross_product_and_normize(const IVP_U_Point *v1,
                                                        const IVP_U_Point *v2) {
  IVP_DOUBLE a = v1->k[1] * v2->k[2];
  IVP_DOUBLE a2 = v2->k[1] * v1->k[2];
  IVP_DOUBLE b = v1->k[2] * v2->k[0];
