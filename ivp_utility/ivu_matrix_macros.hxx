...
void IVP_U_Matrix3::inline_mimult3(const IVP_U_Matrix3 *mb,
...
void IVP_U_Matrix3::inline_mmult3(const IVP_U_Matrix3 *mb,
                                  IVP_U_Matrix3 *m_out) const {
  IVP_U_Point row[3];
  for (int r = 0; r < 3; r++) {
...
void IVP_U_Matrix::inline_mmult4(const IVP_U_Matrix *mb,
                                 IVP_U_Matrix *m_out) const {
...
void IVP_U_Matrix::inline_mimult4(const IVP_U_Matrix *mb,
                                  IVP_U_Matrix *m_out) const {
  IVP_U_Point v_shift_korr;
...
IVP_DOUBLE IVP_U_Quat::inline_estimate_q_diff_to(
    const IVP_U_Float_Quat *to) const {  // roughly estimate the quad alpha
  // cosinus of half angle
  IVP_DOUBLE cosom2 =
      this->x * to->x + this->y * to->y + this->z * to->z + this->w * to->w;
