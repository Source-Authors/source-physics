...
inline void IVP_U_Float_Point::set_to_zero() { k[0] = k[1] = k[2] = 0.0f; }
...
void IVP_U_Float_Point::inline_calc_cross_product(const IVP_U_Float_Point *v1,
  ...
  IVP_FLOAT b2 = v2->k[2] * v1->k[0];
  a -= a2;
  IVP_FLOAT c = v1->k[0] * v2->k[1];
  IVP_FLOAT c2 = v2->k[0] * v1->k[1];
  b -= b2;
  k[0] = a;
  k[1] = b;
  c -= c2;
...
inline void IVP_U_Quat::init() { x = y = z = w = 0.0f; }
