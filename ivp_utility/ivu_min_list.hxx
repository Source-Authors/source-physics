...
class IVP_U_Min_List {
 ...
 public:
  ...
  IVP_U_MINLIST_INDEX add(void *elem,
                          IVP_U_MINLIST_FIXED_POINT value);  // returns an index
  ...
  IVP_BOOL has_elements() { return (IVP_BOOL)(counter > 0); }

  IVP_U_MINLIST_FIXED_POINT find_min_value() { return min_value; }

  void prefetch0_minlist() {
    IVP_IF_PREFETCH_ENABLED(IVP_TRUE) { IVP_PREFETCH(this, 0); }
  }
