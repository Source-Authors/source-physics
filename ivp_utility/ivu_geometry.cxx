...
void IVP_U_Straight::calc_orthogonal_vec_from_point(
    const IVP_U_Point *point, IVP_U_Point *vec_out) const {
  // vorr: normiert!
...
IVP_U_Plain::IVP_U_Plain(const IVP_U_Point *p0, const IVP_U_Point *p1,
...
IVP_U_Straight::IVP_U_Straight(const IVP_U_Point *i_start_point,
                               const IVP_U_Point *i_vec) {
  start_point = *i_start_point;
  vec = *i_vec;
  vec.normize();
}

void IVP_U_Straight::set(const IVP_U_Point *i_start_point,
                         const IVP_U_Point *i_vec) {
  start_point = *i_start_point;
  vec = *i_vec;
  vec.normize();
...
void IVP_U_Straight::set(const IVP_U_Float_Point *i_start_point,
                         const IVP_U_Float_Point *i_vec) {
  start_point = *i_start_point;
  vec = *i_vec;
  vec.normize();
}

IVP_RETURN_TYPE IVP_U_Plain::calc_intersect_with(
    const IVP_U_Hesse *plane2, IVP_U_Straight *straight_out) const {
...
IVP_U_INTERSECT_TYPE IVP_U_Straight::calc_intersect_with(
    const IVP_U_Straight *straight2, IVP_U_Point *p_out, IVP_DOUBLE *dist_out) {
