...
// A blueprint is simply a chunk of memory that contains enough data to
// instantiate an object. An appropriate factory will take a blueprint and
// construct an appropriate object By their nature Blueprints are disposable - a
// persistent blueprint is also provided.
class hk_Blueprint {
 public:
