...
class hk_Ball_Socket_Constraint : public hk_Constraint {
 public:
  hk_Ball_Socket_Constraint(hk_Environment *, const hk_Ball_Socket_BP *,
                            hk_Rigid_Body *a, hk_Rigid_Body *b);
  hk_Ball_Socket_Constraint(hk_Local_Constraint_System *,
                            const hk_Ball_Socket_BP *, hk_Rigid_Body *a,
                            hk_Rigid_Body *b);
  ...
  const char *get_constraint_type() override { return "ball_socket"; }
