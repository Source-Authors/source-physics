...
class hk_Car_Wheel_Constraint : public hk_Constraint {
 public:
  ...
  hk_Car_Wheel_Constraint(hk_Local_Constraint_System *, const hk_Car_Wheel_BP *,
                          hk_Rigid_Body *a, hk_Rigid_Body *b);
 ...
 protected:
  ...
  hk_Vector3
      m_initial_hinge_axis_Ros;  // used to recalculate the m_steering_axis_Ros
                                 // using the set_steering_angle() function
};
