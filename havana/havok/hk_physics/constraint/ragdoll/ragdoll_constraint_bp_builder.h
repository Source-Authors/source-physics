...
class hk_Ragdoll_Constraint_BP_Builder {
 ...
 public:
  hk_result initialize_from_limited_ball_socket_bp(
      const class hk_Limited_Ball_Socket_BP *, hk_Rigid_Body *a,
      hk_Rigid_Body *b);
  ...
  const hk_Ragdoll_Constraint_BP *get_blueprint() const {
    return &m_ragdoll_constraint_bp;
  }
  hk_Ragdoll_Constraint_BP *get_blueprint() { return &m_ragdoll_constraint_bp; }
};
