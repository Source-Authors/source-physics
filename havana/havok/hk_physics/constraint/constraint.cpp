...
hk_Constraint::hk_Constraint(hk_Local_Constraint_System *sys, hk_Rigid_Body *a,
                             hk_Rigid_Body *b,
                             hk_effector_priority redundend_prio,
                             int storage_size)
    // dimhotepus: Apply priority from outside.
    : hk_Rigid_Body_Binary_EF(HK_NULL, a, b,
                              redundend_prio),  // do not link yet
