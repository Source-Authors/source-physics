...
class hk_Pulley_Constraint : public hk_Constraint {
 public:
  ...
  hk_Pulley_Constraint(hk_Environment*, const hk_Pulley_BP*, hk_Rigid_Body* a,
                       hk_Rigid_Body* b);
  hk_Pulley_Constraint(hk_Local_Constraint_System*, const hk_Pulley_BP*,
  ...
  const char* get_constraint_type() override { return "pulley"; }
