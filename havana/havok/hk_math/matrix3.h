...
class hk_Matrix3 {
 public:
  ...
  inline void _set_rows(const hk_Vector3& r0, const hk_Vector3& r1,
                        const hk_Vector3& r2);
  //: Set all values of the matrix at once, rowwise.

  void set_rows(const hk_Vector3& r0, const hk_Vector3& r1,
                const hk_Vector3& r2);
  //: Set all values of the matrix at once, rowwise.

  void set_cols(const hk_Vector3& r0, const hk_Vector3& r1,
                const hk_Vector3& r2);
  //: Set all values of the matrix at once, rowwise.
  ...
  void set_rotated_diagonal_matrix(const hk_Rotation& r,
                                   const hk_Vector3& diagonal_matrix3);
