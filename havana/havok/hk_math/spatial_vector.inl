...
hk_Spatial_Vector::hk_Spatial_Vector(hk_real a, hk_real b, hk_real c, hk_real d,
                                     hk_real e, hk_real f)
...
hk_Spatial_Vector::hk_Spatial_Vector(const hk_Spatial_Vector& v) { *this = v; }
...
void hk_Spatial_Vector::set(hk_real a, hk_real b, hk_real c, hk_real d,
                            hk_real e, hk_real f) {
  top.x = a;
  top.y = b;
  top.z = c;
...
void hk_Spatial_Vector::set_top(const hk_Vector3& a) { top = a; }

void hk_Spatial_Vector::set_bottom(const hk_Vector3& b) { bottom = b; }
...
void hk_Spatial_Vector::set_add(const hk_Spatial_Vector& a,
...
void hk_Spatial_Vector::set_sub(const hk_Spatial_Vector& a,
                                const hk_Spatial_Vector& b) {
  top.x = a.top.x - b.top.x;
  top.y = a.top.y - b.top.y;
  top.z = a.top.z - b.top.z;
...
hk_Spatial_Vector hk_Spatial_Vector::operator+(const hk_Spatial_Vector& v) {
  return hk_Spatial_Vector(top.x + v.top.x, top.y + v.top.y, top.z + v.top.z,
                           bottom.x + v.bottom.x, bottom.y + v.bottom.y,
                           bottom.z + v.bottom.z);
}
...
void hk_Spatial_Vector::_set_transformed_pos(const hk_Spatial_Matrix& T,
                                             const hk_Spatial_Vector& v) {
  ...
  for (int i = 0; i < 6; i++) {
    *(element + i) = T(i, 0) * v.top.x + T(i, 1) * v.top.y + T(i, 2) * v.top.z +
                     T(i, 3) * v.bottom.x + T(i, 4) * v.bottom.y +
                     T(i, 5) * v.bottom.z;
  }
