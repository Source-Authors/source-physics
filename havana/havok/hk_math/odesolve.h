...
typedef void (*dydt_function)(hk_real t, const hk_real statev[],
                              hk_real delta_statev[], void *client_data);
...
class OdeSolver {
 public:
  ...
  // in y1
  virtual void calc_step(hk_real y0[], hk_real y1[], unsigned int len,
...
class OdeRungaKutta4 : public OdeSolver {
 public:
  ...
  void calc_step(hk_real y0[], hk_real y1[], unsigned int len, hk_real t0,
                 hk_real t1, dydt_function dydt, void *client_data) override;
