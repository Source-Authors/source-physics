hk_Quaternion::hk_Quaternion(const hk_Rotation& r) { this->set(r); }

void hk_Quaternion::set_identity() { this->set4(0, 0, 0, 1); }
...
void hk_Quaternion::normalize_quaternion() { this->normalize4(); }
...
inline const hk_Vector3& hk_Quaternion::get_imag() const { return *this; }
