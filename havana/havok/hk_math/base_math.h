...
constexpr inline hk_real HK_REAL_EPS{
    1e-16f}; /* the minumum resolution of real */
constexpr inline hk_real HK_REAL_RES{
    1e-7f}; /* resolution of hk_real of  relative to 1.0f */
constexpr inline hk_double HK_DOUBLE_RES{
...
class hk_Math {
 public:
  ...
  static inline hk_real fast_approx_atan2
      [[nodiscard]] (hk_real sinus, hk_real cosinus);  // 0.01 error
  static inline hk_real fast_approx_atan2_normized [[nodiscard]] (
      hk_real sinus,
      hk_real cosinus);  // 0.01 error // input has to be normized
  ...
  static inline hk_real clamp
      [[nodiscard]] (hk_real v, hk_real min, hk_real max);
  ...
  static bool almost_equal
      [[nodiscard]] (hk_real a, hk_real b, hk_real eps = HK_REAL_RES);
  static bool almost_equal
      [[nodiscard]] (hk_double a, hk_double b, hk_double eps = HK_DOUBLE_RES);
  static bool almost_zero [[nodiscard]] (hk_real a, hk_real eps = HK_REAL_RES);
  static bool almost_zero
      [[nodiscard]] (hk_double a, hk_double eps = HK_DOUBLE_RES);
};
