...
class hk_Transform : public hk_Rotation {
 public:
  ...
  void set_cols4(const hk_Vector3& c0, const hk_Vector3& c1,
                 const hk_Vector3& c2, const hk_Vector3& c3);
  //:
  inline void _set_interpolate(const hk_QTransform& a, const hk_QTransform& b,
                               hk_real t);
  void set_interpolate(const hk_QTransform& a, const hk_QTransform& b,
                       hk_real t);
