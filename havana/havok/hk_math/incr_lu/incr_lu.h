...
class hk_Incr_LU_Matrix {
  ...
  void add_neg_row_to_row_l_u(int pivot_row, int dest_row,
  ...
  void add_neg_row_upwards_l_u(int row_down, int dest_row,
                               hk_incrlu_real factor);
 ...
 public:
  ...
  void
  solve_lin_equ();  // input and output is stored/found in vector m_inout_vec
