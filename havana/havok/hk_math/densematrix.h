...
class hk_Dense_Matrix {
 public:
  ...
  inline void set_size(int r, int c) {
    m_rows = r;
    m_cols = c;
  }
  ...
  void mult_vector(const hk_real* x_vector,
                   hk_real* result_vector) const;  // both vectors are aligned
