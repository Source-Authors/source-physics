...
inline hk_Vector3::hk_Vector3(const double* d)
    : x(static_cast<hk_real>(d[0])),
      y(static_cast<hk_real>(d[1])),
      z(static_cast<hk_real>(d[2])),
      w(0) {}
...
inline hk_Vector3::hk_Vector3(const hk_Vector3& v) { *this = v; }
...
struct hkVector3ExpressionPlus {
  hkVector3ExpressionPlus(const hk_Vector3& a, const hk_Vector3& b)
      : m_a(a), m_b(b) {}
  const hk_Vector3& m_a;
  const hk_Vector3& m_b;
};
struct hkVector3ExpressionMinus {
  hkVector3ExpressionMinus(const hk_Vector3& a, const hk_Vector3& b)
      : m_a(a), m_b(b) {}
  const hk_Vector3& m_a;
  const hk_Vector3& m_b;
};
...
inline hk_Vector3::hk_Vector3(ConsT hkVector3ExpressionPlus HK_REF v) {
  operator=(v);
  // dimhotepus: Add missed w component init just in case.
  w = 0;
}
...
inline void hk_Vector3::set_zero() { x = y = z = 0; }
...
void hk_Vector3::set_interpolate(const hk_Vector3& v0, const hk_Vector3& v1,
                                 hk_real t) {
  hk_real s = 1.0f - t;
...
void hk_Vector3::set_cross(const hk_Vector3& v1, const hk_Vector3& v2) {
  ...
  hk_real b = v1(2) * v2(0);
  hk_real b2 = v2(2) * v1(0);
  a -= a2;
  hk_real c = v1(0) * v2(1);
  hk_real c2 = v2(0) * v1(1);
  b -= b2;
  x = a;
  y = b;
  c -= c2;
...
void hk_Vector3::_set_transformed_pos(const hk_Transform& r,
                                      const hk_Vector3& v) {
...
void hk_Vector3::_set_rotated_inv_dir(const hk_Rotation& r,
                                      const hk_Vector3& v) {
...
void hk_Vector3::_set_transformed_inv_pos(const hk_Transform& r,
                                          const hk_Vector3& v) {
...
void hk_Vector3::normalize() { *this *= this->length_inv(); }
...
hk_real& hk_Vector3::operator()(int a) { return (&x)[a]; }

const hk_real& hk_Vector3::operator()(int a) const { return (&x)[a]; }

/* expressions */

inline Const hkVector3ExpressionPlus operator+(const hk_Vector3& a,
                                               const hk_Vector3& b) {
  return hkVector3ExpressionPlus(a, b);
}
inline Const hkVector3ExpressionMinus operator-(const hk_Vector3& a,
                                                const hk_Vector3& b) {
