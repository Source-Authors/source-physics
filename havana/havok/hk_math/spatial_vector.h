...
class hk_Spatial_Vector {
 public:
  ...
  inline hk_Spatial_Vector(hk_real a, hk_real b, hk_real c, hk_real d,
                           hk_real e, hk_real f);
  ...
  inline void set(hk_real a, hk_real b, hk_real c, hk_real d, hk_real e,
                  hk_real f);
  ...
  void set_transformed_pos(const hk_Spatial_Matrix& a,
                           const hk_Spatial_Vector& b);
  inline void _set_transformed_pos(const hk_Spatial_Matrix& a,
                                   const hk_Spatial_Vector& b);
